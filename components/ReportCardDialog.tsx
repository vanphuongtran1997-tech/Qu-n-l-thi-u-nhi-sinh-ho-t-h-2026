...
export function ReportCardDialog({
  ...
  const handleExportPDF = () => {
    const element = document.getElementById(`report-card-${student.id}`);
    if (!element) return;
    const opt = {
      margin: 10,
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[700px]">
        ...
        <div className="flex flex-col py-4 max-h-[70vh] overflow-y-auto">
          <div className="print-document" id={`report-card-${student.id}`}>
            <div className="bg-white p-8 max-w-3xl mx-auto border border-neutral-200">
              ...
              <div className="mb-8 border border-neutral-300 rounded-md overflow-hidden">
